...
// Includes client, event type, status, actor, and date range filters.
...
export function TimelineFilters({ filters, clients, onChange, onReset }: Props) {
  const hasFilters = filters.clientId || filters.eventType || filters.status || filters.actor || filters.dateFrom || filters.dateTo;
