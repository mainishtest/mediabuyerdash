// app/creative-lab/queue/page.tsx
// Legacy workflow queue view — preserved for backward compatibility.
// The main Creative Lab page now uses the unified workflow at /creative-lab.
...
export default async function CreativeLabQueuePage({ searchParams }: PageProps) {
...
function deriveRecommendation(s: CreativePerformanceSnapshot): {
  headline: string; rationale: string; nextAction: string;
} {
