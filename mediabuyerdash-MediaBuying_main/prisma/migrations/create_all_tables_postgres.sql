-- =============================================================================
-- create_all_tables_postgres.sql
-- =============================================================================
-- Idempotent: creates all tables, indexes, and FKs that are missing.
-- Safe to run multiple times. Run this in the Neon SQL editor to fix
-- "table does not exist" errors.
-- Generated from: prisma migrate diff --from-empty --to-schema prisma/schema.prisma
-- =============================================================================
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaAccessibleAdAccount" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSelectedAdAccount" (
    "id" TEXT NOT NULL,
    "metaConnectionId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "UTMPerformanceRow" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CRMPerformanceRow" (
    "id" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
    "date" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeApproval" (
    "id" TEXT NOT NULL,
    "jobId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GenerationPromptSnapshot" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GenerationProviderRequest" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
    "provider" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GenerationProviderResponse" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
    "provider" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GeneratedCopyVariation" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "hook" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GeneratedImageVariation" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GenerationApprovalDecision" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SelectedCreativeVariant" (
    "id" TEXT NOT NULL,
    "generationRunId" TEXT NOT NULL,
    "variationType" TEXT NOT NULL,
    "variationId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "LaunchDraft" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "LaunchDraftVariant" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ExperimentResultRecord" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ExperimentLearningRecord" (
    "id" TEXT NOT NULL,
    "experimentId" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
    "briefIntent" TEXT,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "PublishPrepRecord" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSyncedCampaign" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT,
    "externalAdAccountId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSyncedAdSet" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT,
    "externalAdAccountId" TEXT NOT NULL,
    "externalCampaignId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSyncedAd" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT,
    "externalAdAccountId" TEXT NOT NULL,
    "externalCampaignId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSyncedCreative" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "MetaSyncedInsight" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT,
    "externalAdAccountId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ShopifyOrderLineItem" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ReconciliationSummary" (
    "id" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ClientSyncRun" (
    "id" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ClientSyncRunStep" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeLabWorkflowItem" (
    "id" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeLabActivityLog" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeBriefRecord" (
    "id" TEXT NOT NULL,
    "clientAccountId" TEXT NOT NULL,
    "campaignId" TEXT,
    "creativeId" TEXT,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeDraftVariantRecord" (
    "id" TEXT NOT NULL,
    "briefId" TEXT NOT NULL,
    "variantType" TEXT NOT NULL,
    "title" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "CreativeGenerationJobRecord" (
    "id" TEXT NOT NULL,
    "briefId" TEXT NOT NULL,
    "mode" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ActionSafetyPolicy" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
    "scope" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "GovernanceStop" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
    "scope" TEXT NOT NULL,
    "scopeId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "AutomationOverride" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "NotificationLog_workspaceId_idx" ON "NotificationLog"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "NotificationLog_deduplicationKey_idx" ON "NotificationLog"("deduplicationKey");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ClientAccount_clientPortalToken_key" ON "ClientAccount"("clientPortalToken");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CampaignGoal_campaignId_key" ON "CampaignGoal"("campaignId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaConnection_metaUserId_key" ON "MetaConnection"("metaUserId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaAccessibleAdAccount_metaConnectionId_externalAdAccountI_key" ON "MetaAccessibleAdAccount"("metaConnectionId", "externalAdAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSelectedAdAccount_accessibleAdAccountId_key" ON "MetaSelectedAdAccount"("accessibleAdAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CreativeApproval_jobId_variationId_key" ON "CreativeApproval"("jobId", "variationId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "GenerationPromptSnapshot_generationRunId_key" ON "GenerationPromptSnapshot"("generationRunId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "GenerationProviderRequest_generationRunId_key" ON "GenerationProviderRequest"("generationRunId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "GenerationProviderResponse_generationRunId_key" ON "GenerationProviderResponse"("generationRunId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "SelectedCreativeVariant_generationRunId_variationType_key" ON "SelectedCreativeVariant"("generationRunId", "variationType");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentRecord_clientAccountId_idx" ON "ExperimentRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentRecord_challengerPrepItemId_idx" ON "ExperimentRecord"("challengerPrepItemId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentRecord_status_idx" ON "ExperimentRecord"("status");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ExperimentResultRecord_experimentId_key" ON "ExperimentResultRecord"("experimentId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentResultRecord_experimentId_idx" ON "ExperimentResultRecord"("experimentId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLearningRecord_clientAccountId_idx" ON "ExperimentLearningRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLearningRecord_briefIntent_idx" ON "ExperimentLearningRecord"("briefIntent");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLearningRecord_experimentId_idx" ON "ExperimentLearningRecord"("experimentId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeTestResultRecord_clientAccountId_idx" ON "CreativeTestResultRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeTestResultRecord_launchPlanId_idx" ON "CreativeTestResultRecord"("launchPlanId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeTestResultRecord_experimentId_idx" ON "CreativeTestResultRecord"("experimentId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeTestResultRecord_trackingState_idx" ON "CreativeTestResultRecord"("trackingState");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeTestResultRecord_outcome_idx" ON "CreativeTestResultRecord"("outcome");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLifecycleResultLinkRecord_testResultId_idx" ON "CreativeLifecycleResultLinkRecord"("testResultId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLifecycleResultLinkRecord_prepItemId_idx" ON "CreativeLifecycleResultLinkRecord"("prepItemId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLifecycleResultLinkRecord_clientAccountId_idx" ON "CreativeLifecycleResultLinkRecord"("clientAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "CreativeOutcomeRouteRecord_testResultId_key" ON "CreativeOutcomeRouteRecord"("testResultId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeOutcomeRouteRecord_clientAccountId_idx" ON "CreativeOutcomeRouteRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeOutcomeRouteRecord_readinessState_idx" ON "CreativeOutcomeRouteRecord"("readinessState");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeOutcomeRouteRecord_routeType_idx" ON "CreativeOutcomeRouteRecord"("routeType");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeOutcomeRouteRecord_testResultId_idx" ON "CreativeOutcomeRouteRecord"("testResultId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLaunchPlanRecord_clientAccountId_idx" ON "ExperimentLaunchPlanRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLaunchPlanRecord_prepItemId_idx" ON "ExperimentLaunchPlanRecord"("prepItemId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ExperimentLaunchPlanRecord_readinessState_idx" ON "ExperimentLaunchPlanRecord"("readinessState");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "PublishPrepRecord_briefId_idx" ON "PublishPrepRecord"("briefId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "PublishPrepRecord_variantId_idx" ON "PublishPrepRecord"("variantId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "PublishPrepRecord_clientAccountId_idx" ON "PublishPrepRecord"("clientAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSyncedCampaign_externalCampaignId_key" ON "MetaSyncedCampaign"("externalCampaignId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedCampaign_workspaceId_idx" ON "MetaSyncedCampaign"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedCampaign_workspaceId_externalAdAccountId_idx" ON "MetaSyncedCampaign"("workspaceId", "externalAdAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaCampaignGoal_externalCampaignId_key" ON "MetaCampaignGoal"("externalCampaignId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaCampaignGoal_externalCampaignId_idx" ON "MetaCampaignGoal"("externalCampaignId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ClientGoalDefaults_clientAccountId_key" ON "ClientGoalDefaults"("clientAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSyncedAdSet_externalAdSetId_key" ON "MetaSyncedAdSet"("externalAdSetId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedAdSet_workspaceId_idx" ON "MetaSyncedAdSet"("workspaceId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSyncedAd_externalAdId_key" ON "MetaSyncedAd"("externalAdId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedAd_workspaceId_idx" ON "MetaSyncedAd"("workspaceId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSyncedCreative_externalCreativeId_key" ON "MetaSyncedCreative"("externalCreativeId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedCreative_workspaceId_idx" ON "MetaSyncedCreative"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedInsight_externalAdAccountId_dateStart_idx" ON "MetaSyncedInsight"("externalAdAccountId", "dateStart");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "MetaSyncedInsight_workspaceId_dateStart_idx" ON "MetaSyncedInsight"("workspaceId", "dateStart");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MetaSyncedInsight_externalAdAccountId_level_externalCampaig_key" ON "MetaSyncedInsight"("externalAdAccountId", "level", "externalCampaignId", "externalAdSetId", "externalAdId", "dateStart");
-- CreateIndex
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ShopifyOrder_shopifyConnectionId_orderCreatedAt_idx" ON "ShopifyOrder"("shopifyConnectionId", "orderCreatedAt");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ShopifyOrder_clientAccountId_orderCreatedAt_idx" ON "ShopifyOrder"("clientAccountId", "orderCreatedAt");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ShopifyOrder_workspaceId_orderCreatedAt_idx" ON "ShopifyOrder"("workspaceId", "orderCreatedAt");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ShopifyOrder_shopifyConnectionId_externalOrderId_key" ON "ShopifyOrder"("shopifyConnectionId", "externalOrderId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ReconciliationMatch_clientAccountId_date_idx" ON "ReconciliationMatch"("clientAccountId", "date");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ReconciliationMatch_clientAccountId_matchKey_key" ON "ReconciliationMatch"("clientAccountId", "matchKey");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ReconciliationSummary_clientAccountId_dateFrom_idx" ON "ReconciliationSummary"("clientAccountId", "dateFrom");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ReconciliationSummary_clientAccountId_dateFrom_dateTo_key" ON "ReconciliationSummary"("clientAccountId", "dateFrom", "dateTo");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ReconciledCampaignPerformance_clientAccountId_dateFrom_idx" ON "ReconciledCampaignPerformance"("clientAccountId", "dateFrom");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ReconciledCampaignPerformance_clientAccountId_externalCampa_key" ON "ReconciledCampaignPerformance"("clientAccountId", "externalCampaignId", "dateFrom", "dateTo");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlertEvent_clientAccountId_status_idx" ON "AlertEvent"("clientAccountId", "status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlertEvent_status_severity_idx" ON "AlertEvent"("status", "severity");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlertEvent_workspaceId_status_idx" ON "AlertEvent"("workspaceId", "status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlertEvent_deduplicationKey_idx" ON "AlertEvent"("deduplicationKey");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ClientSyncRun_clientAccountId_startedAt_idx" ON "ClientSyncRun"("clientAccountId", "startedAt");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "UploadedCreativeImage_workspaceId_idx" ON "UploadedCreativeImage"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "UploadedCreativeImage_clientAccountId_idx" ON "UploadedCreativeImage"("clientAccountId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "UploadedCreativeAnalysis_uploadedCreativeImageId_key" ON "UploadedCreativeAnalysis"("uploadedCreativeImageId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "GeneratedImageIterationConcept_uploadedCreativeImageId_idx" ON "GeneratedImageIterationConcept"("uploadedCreativeImageId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationRule_workspaceId_idx" ON "AutomationRule"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ProposedAutomationAction_workspaceId_idx" ON "ProposedAutomationAction"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ProposedAutomationAction_clientAccountId_idx" ON "ProposedAutomationAction"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ProposedAutomationAction_deduplicationKey_idx" ON "ProposedAutomationAction"("deduplicationKey");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ProposedAutomationAction_status_idx" ON "ProposedAutomationAction"("status");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "AutoExecutionSettings_clientAccountId_key" ON "AutoExecutionSettings"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutoExecutionSettings_workspaceId_idx" ON "AutoExecutionSettings"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutoExecutionLog_workspaceId_idx" ON "AutoExecutionLog"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutoExecutionLog_clientAccountId_executedAt_idx" ON "AutoExecutionLog"("clientAccountId", "executedAt");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutoExecutionLog_status_idx" ON "AutoExecutionLog"("status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "BudgetPacingTarget_clientAccountId_idx" ON "BudgetPacingTarget"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "BudgetPacingTarget_clientAccountId_campaignId_idx" ON "BudgetPacingTarget"("clientAccountId", "campaignId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLabWorkflowItem_clientAccountId_idx" ON "CreativeLabWorkflowItem"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLabWorkflowItem_status_idx" ON "CreativeLabWorkflowItem"("status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeLabActivityLog_itemId_idx" ON "CreativeLabActivityLog"("itemId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeBriefRecord_clientAccountId_idx" ON "CreativeBriefRecord"("clientAccountId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeBriefRecord_status_idx" ON "CreativeBriefRecord"("status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeBriefRecord_sourceItemId_idx" ON "CreativeBriefRecord"("sourceItemId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeDraftVariantRecord_briefId_idx" ON "CreativeDraftVariantRecord"("briefId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeDraftVariantRecord_generationJobId_idx" ON "CreativeDraftVariantRecord"("generationJobId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeGenerationJobRecord_briefId_idx" ON "CreativeGenerationJobRecord"("briefId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "CreativeGenerationJobRecord_status_idx" ON "CreativeGenerationJobRecord"("status");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ActionSafetyPolicy_workspaceId_idx" ON "ActionSafetyPolicy"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "ActionSafetyPolicy_scope_scopeId_idx" ON "ActionSafetyPolicy"("scope", "scopeId");
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ActionSafetyPolicy_workspaceId_scope_scopeId_key" ON "ActionSafetyPolicy"("workspaceId", "scope", "scopeId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationAuditLog_workspaceId_idx" ON "AutomationAuditLog"("workspaceId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationAuditLog_clientAccountId_occurredAt_idx" ON "AutomationAuditLog"("clientAccountId", "occurredAt");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationAuditLog_eventType_idx" ON "AutomationAuditLog"("eventType");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationAuditLog_actionType_idx" ON "AutomationAuditLog"("actionType");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationAuditLog_relatedActionId_idx" ON "AutomationAuditLog"("relatedActionId");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "GovernanceStop_workspaceId_isActive_idx" ON "GovernanceStop"("workspaceId", "isActive");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "GovernanceStop_scope_scopeId_isActive_idx" ON "GovernanceStop"("scope", "scopeId", "isActive");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationOverride_workspaceId_isActive_idx" ON "AutomationOverride"("workspaceId", "isActive");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationOverride_scope_scopeId_isActive_idx" ON "AutomationOverride"("scope", "scopeId", "isActive");
-- CreateIndex
CREATE INDEX IF NOT EXISTS "AutomationOverride_actionId_idx" ON "AutomationOverride"("actionId");
-- AddForeignKey
DO $$ BEGIN
