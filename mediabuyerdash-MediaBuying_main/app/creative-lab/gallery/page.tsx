// app/creative-lab/gallery/page.tsx
...
//   5. Pass merged items to the client GalleryView.
...
export const metadata = {
  title: "Creative Gallery — Media Buying Dashboard",
};
...
export default async function CreativeGalleryPage({ searchParams }: PageProps) {
