...
// Navigation reorganized to match daily media buyer workflow:
// 1. Command Center (daily start) → 2. Performance → 3. Creative → 4. Operations
// Portfolio & Dashboard grouped under a top-level section to reduce clutter.
const NAV: NavEntry[] = [
  {
    kind:  "leaf",
    href:  "/command-center",
  ...
  },
  {
    ...
    icon:  "◈",
    children: [
      { kind: "leaf", href: "/portfolio",          label: "Portfolio"        },
  ...
  },
  {
    ...
    children: [
      ...
      { kind: "leaf", href: "/creative-lab/gallery",      label: "Creative Gallery"     },
  ...
  },
  {
    ...
    children: [
      ...
      { kind: "leaf", href: "/dashboard",    label: "Dashboard"    },
      { kind: "leaf", href: "/portfolio/governance", label: "Governance" },
      { kind: "leaf", href: "/portfolio/controls",   label: "Controls"   },
    ],
  },
  {
    kind:  "leaf",
