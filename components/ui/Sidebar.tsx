...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    icon:  "◇",
    children: [
      { kind: "leaf", href: "/video-ads",                    label: "Video Ad Generator"   },
      { kind: "leaf", href: "/video-ads/assets",             label: "Creative Assets"      },
      { kind: "leaf", href: "/launch",                       label: "Campaign Launcher"    },
      { kind: "leaf", href: "/campaign-agent",               label: "Operator Agent"       },
      ...
      { kind: "leaf", href: "/creative-history",             label: "Generation History"   },
      { kind: "leaf", href: "/launch-drafts",                label: "Launch Drafts"        },
      { kind: "leaf", href: "/creative-intelligence",        label: "Creative Intelligence"},
  ...
  },
  {
    ...
    children: [
      ...
      { kind: "leaf", href: "/clients/settings", label: "Client Settings" },
